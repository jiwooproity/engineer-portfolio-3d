import "@/shared/assets/css/mobile/mobile-guide.css";

import preview_loader from "@/shared/assets/images/mobile/preview-loader.png";
import preview_main from "@/shared/assets/images/mobile/preview-main.png";
import preview_zoom from "@/shared/assets/images/mobile/preview-zoom.png";

import { memo } from "react";

const MobileGuide = memo(
  () => {
    return (
      <div className="guide-container">
        ...
        <div className="guide-content">
          ...
          <p>
            작업물을 확인하실 분은 PC 환경으로 접속해 주시면 감사하겠습니다.
          </p>
        </div>
        <div className="guide-title-box">
        ...
        <div className="guide-content">
          ...
          <p>
            마우스에 따라 모델이 작은 움직임으로 애니메이션을 가지게 되며,
            맥북을 클릭하면 줌과 함께 다음 컨텐츠를 즐길 수 있습니다.
          </p>
          <img src={preview_main} />
          <h1 className="guide-img-title">Zoom to Macbook Air && Action OS</h1>
          <p>
            줌과 함께 맥북이 확대되고, 화면에 iframe을 통한 웹 페이지가
            렌더링되어 있어 웹 사이트처럼 동작이 가능합니다.
          </p>
          <p>
